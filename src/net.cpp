...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Legendcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"legendcoin.org", "dnsseed.legendcoin.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"legendcoin.org", "testnet-seed.legendcoin.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Legendcoin is probably already running."), addrBind.ToString().c_str());
        else
